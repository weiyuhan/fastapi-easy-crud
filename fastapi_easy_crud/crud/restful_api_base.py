...
class BaseAPI(
    ...
    def to_model(self, db_model: Any) -> GetSchemaType:
        return self.get_schema_type.from_orm(db_model)
    ...
    def init_router(self, router: APIRouter) -> None:
        ...
        async def get_by_id(id: int, db: Session = Depends(deps.get_db)) -> Any:
        ...
        async def delete(id: int, db: Session = Depends(deps.get_db)) -> Any:
